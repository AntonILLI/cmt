...
<>
        <div className="container">
          ...
          <div id="modal1" className="modal bottom-sheet">
            ...
            <button onClick={this.modalIsActive} className="modal-close btn-small btn-floating waves-effect waves-light red">
        ...
        <a onClick={this.modalIsActive} className="modal-trigger btn-floating btn-large waves-effect waves-light red pulse" href="#modal1">
